...
// Required
foreach ( $cptPosts_Types as $postType ) {
    require_once $cptFolder . '/' . $postType; // Load all the custom post type
}

/**
 * Register required files
 */
$reqFolder = __DIR__ . '/../inc';
$reqFiles = array (
...
foreach ( $reqFiles as $file ) {
    require_once $reqFolder . '/' . $file; // Load all the required files
}