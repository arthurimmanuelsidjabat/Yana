...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220402_arthurimmanuel_fe2addc4592ca6f31647_20220402221351_archive.zip';
	const ARCHIVE_SIZE		 = '93777299';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fe2addc-02221351';
    const SECONDARY_PACKAGE_HASH = '9b61b5a-02221351';
	const VERSION			 = '1.4.4';
